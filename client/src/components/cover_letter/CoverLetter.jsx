          ...
          <>
            ...
            <form onSubmit={handleCoverLetterSubmit}>
              ...
              <p className="disclaimer">
                While this cover letter may have done 99% of the work for you,
                we cannot guarantee the accuracy of the AI response.
              </p>
              <p className="disclaimer">
                We recommend taking the time to thoroughly check it for errors
                and reformat the letter as needed.
              </p>
